...
## Документация: 
- [чек-лист](reports\Check.xlsx);
- [тест-кейс](reports\Cases.xlsx).
...
## План работы
- Составить чек-лист - 20-23 декабря;
- Составить тест-кейс - 26-29 декабря;
- Автоматизация тестирования - 30 декабря-10 января;
- Составить отчеты 11-12 января.
