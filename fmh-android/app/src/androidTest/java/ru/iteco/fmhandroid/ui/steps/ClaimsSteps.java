...
public class ClaimsSteps {
    ...
    public void isClaimsScreen() {
        Allure.step("Проверка элементов экрана Заявки");
    ...
    public void isFilterWindow() {
        Allure.step("Проверка элеменмтов окна Фильтр");
    ...
    public void clickCommentEditBtn(int index) {
        Allure.step("Кликнуть кнопку редактирвования комментария");
    ...
    public void statusIconIsDisplayed() {
        Allure.step("Проверка видимости статуса заявки");
        claimsScreen.statusIcon.check(matches(isDisplayed()));
    }

    public void checkClaimElements() {
        Allure.step("Проверка элементов заявки");
    ...
    public void claimsListLoaded() {
        Allure.step("Загрузка списка заявок");
